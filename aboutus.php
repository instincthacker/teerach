...
.skewedimg1 {
    position: relative;
    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(images/aboutus/about1.jpg) center center;
...
.skewedimg2 {
    position: relative;
    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(images/aboutus/about3.jpg) center center no-repeat;
...
.skewedimg3 {
    position: relative;
    background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(images/aboutus/about2.jpg) center center;
                ...
                <div class="session-vad row-reverse"> 
                    <div class="content-mobile"> 
                        <div class="sub-mobile"> 
                            <h2 style="color:white;">DATABAR Provides</h2> 
...
-->                     
            ...
            <div class="skewedimg3"> 
                <div class="session-vad row-reverse"> 
                    <div class="content-mobile"> 
                        <div class="sub-mobile"> 
                            <h2 style="color:white;">We Aim To Enhance</h2> 
                            <p style="color:white;">We aim to enhance your business with seamless provision of Samsung enterprise mobility, non-Samsung mobility, barcode and complementary mobility solutions, and authorized repair services.</p> 
                        </div>                         
                    </div>                     
                    <!--
                <div class="mobile">
...
@media (max-width: 991px) {
    ...
    .bglack {
                            ...
                            <div class="tab"> 
                                <div class="warp-cen"> 
                                    <div class="icon-size" style="color: #999; "> 
                                        <button class="icon1 tablink active" onclick="openNumb(event,'1')"> 
                                            <i class="far fa-check-square " style="position: relative; text-align: center;"></i> 
                                        </button>                                         
                                        <button class="icon2 tablink" onclick="openNumb(event,'2')"> 
                                            <i class="fab fa-product-hunt"></i> 
                                        </button>                                         
                                        <button class="icon3 tablink" onclick="openNumb(event,'3')"> 
                                            <i class="fas fa-shipping-fast"></i> 
                                        </button>                                         
                                        <button class="icon4 tablink" onclick="openNumb(event,'4')"> 
                                            <i class="far fa-handshake"></i> 
                                        </button>                                         
                                        <button class="icon5 tablink" onclick="openNumb(event,'5')"> 
        ...
        <style type="text/css">.display-container {
    position: relative;
}
            ...
            <div class="display-container" style="padding:20px; background-color: black;"> 
                <center> 
                    ...
                    <div class="Comp icon-size" style="color:#999;"> 
                        ...
                        <button class="arrow-button display-right" onclick="plusDivs(1)">&#10095;</button>                         
                </center>                 
            </div>             
        </div>         
    </div>     
