                    ...
                    <div class="col-md-10 col-md-offset-1"> 
                        ...
                        <div id="1" class="Numb"> 
                            <div class="col-md-6" style="padding:0 2% 0 2%;"> 
                                ...
                                <div class="icon-contact"> 
                                    <a href="#">
                                        <img src="images/contact/www.png" alt="" width="40px"> &nbsp;www.databar.co.th
                                    </a>                                     
                                    <a href="line://ti/p/@als8485h">
                                        <img src="images/contact/line.png" alt="" width="40px"> &nbsp;@Databar
                                    </a>                                     
                                    <a href="https://www.facebook.com/VAD.databar" target="_blank">
                                        <img src="images/contact/facebook.png" alt="" width="40px"> &nbsp;VAD.databar
                                    </a>                                     
                                </div>                                 
                            </div>                             
                            <div class="col-md-6 box-border" style="padding:0 2% 0 2%;"> 
                                ...
                                <div class="row" style="padding: 3% 2.5% 0 2.5%; "> 
                                    <a href="images/map_CDC.jpg" class="image-popup" style="font-weight:100;"> 
                                        ...
                                        <button type="button" class="btn btn-databar">View Images</button>
                                    </img>                                     
                                </a>                                 
                                <a href="images/databarcdc.jpg" class="image-popup"></a> 
                                <a href="print.php" target="_blank"> 
                                    <img onerror="this.style.display='none'">
                                    <button type="button" class="btn btn-databar" style="margin: 0 4px 0 4px;">Click To Print</button>
                                </img>                                 
                            </a>                             
                ...
                <div id="2" class="Numb" style="display:none;"> 
                    ...
                    <div class="col-md-6 box-border" style="padding:0 2% 0 2%;"> 
                        ...
                        <div class="row" style="padding: 3% 2.5% 0 2.5%; "> 
                            <a href="images/map_CDC.jpg" class="image-popup" style="font-weight:100;"> 
                                <img onerror="this.style.display='none'">
                                <button type="button" class="btn btn-databar" style="font-family: 'Kanit', sans-serif;">เปิดแผนที่</button>
                            </img>                             
                        </a>                         
                        <a href="images/databarcdc.jpg" class="image-popup"></a> 
                        <a href="print.php" target="_blank"> 
                            <img onerror="this.style.display='none'">
                            <button type="button" class="btn btn-databar" style="font-family: 'Kanit', sans-serif; margin: 0 4px 0 4px;">พิมพ์แผนที่</button>
                        </img>                         
                    </a>                     
                    <div class="button-box" style="float:right;"> 
                        <button class="tablink active" onclick="openNumb(event,'1')">EN</button>                         
